...
import ma.emsi.androidonlinequizapp.Model.Category;
import ma.emsi.androidonlinequizapp.ViewHolder.CategoryViewHolder;
            ...
            protected void populateViewHolder(CategoryViewHolder viewHolder, final Category model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                       // Toast.makeText(getActivity(),String.format("%s|%s",adapter.getRef(position).getKey(),position,model.getName()), Toast.LENGTH_SHORT).show();
